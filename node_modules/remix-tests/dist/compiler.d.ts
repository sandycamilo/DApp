 ...
 */
export declare function compileFileOrFiles(filename: string, isDirectory: boolean, opts: any, cb: Function): void;
/**
 ...
 * @param cb Callback
 */
export declare function compileContractSources(sources: SrcIfc, compilerConfig: CompilerConfiguration, importFileCb: any, opts: any, cb: Function): void;
